 ...
 *
 * `workspace` skills live in `~/.anyapp/skills/` and are offered to every app.
 */
...
export interface Skill extends SkillDraft {
  ...
  bodyTokens: number
  /** True when the body still matches a seed anyapp has since corrected. */
  outdated: boolean
...
export interface SkillLibrary {
  ...
  app: Skill[]
  /** Skills from `~/.anyapp/skills/`, shared by every app. */
  workspace: Skill[]
}
