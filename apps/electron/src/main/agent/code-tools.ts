 ...
 * exception is `apply_fix`, whose `line` is the number anyapp printed in the diagnostics
 ...
 * and Pi's docs recommend them. They would be dead metadata here: anyapp supplies
