 ...
 * workspace's `~/.keylimepi/skills` holds the ones every app is offered.
 *
...
import { activeSkills, buildSkillLibrary } from '@keylimepi/shared'
import type { Skill, SubApp } from '@keylimepi/core'
 ...
 */
export const WORKSPACE_SKILLS_DIR = join(homedir(), '.keylimepi', 'skills')
 ...
 * the path is Key Lime Pi's to choose, and this is the one the agent already reaches for
