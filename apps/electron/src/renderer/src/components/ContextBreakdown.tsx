 ...
 * model's architectural maximum, not what the daemon sized it to, so a window Key Lime Pi had
 ...
 * a *miss* costs, not what the next turn will cost — Key Lime Pi works to keep the prefix
