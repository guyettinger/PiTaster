...
anyapp runs a coding agent with your permissions, on your filesystem. This page
...
with the process's permissions. So confinement is anyapp's job, and it happens in
...
rests on. It's built by joining an app id onto `~/.anyapp/apps`, and `join`
