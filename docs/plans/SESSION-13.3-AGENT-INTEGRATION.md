...
import type { ElementContext } from '@keylimepi/core/messages'
...
```typescript
const systemPrompt = `You are an AI coding assistant for Key Lime Pi...
...
function createBanner(): HTMLDivElement {
  ...
  banner.id = 'keylimepi-inspector-banner'
