...
Key Lime Pi a visual identity: design tokens, two bundled typefaces, one icon set, a
...
- **The contextual gating was backwards.** Skills and Sources were both
  ...
  `~/.keylimepi`, unrelated to the open app. Meanwhile History, Terminal, and Preview
...
```
┌────────────────────────────────────────────────────────────────┐
│ ●●●   ◈ Key Lime Pi │ Magic 8 Ball ● :5173 │ Ask to edit ▾  ▶ Run   │  h-11, drag
├════════════════════════════════════════════════════════════════┤  ← mode hairline
│ APPS │ MAGIC 8 BALL │                                          │
│ SKILLS│  ⎇ main     │                                          │
│      │  CHATS  +New │              Chat                        │
